...
function Mobile({fetchUrl}) {
    ...
    useEffect(() => {
        async function fetchData() {
            const request = await axios.get(`https://newsapi.org/v2/everything?q=new smart phone in india&from=today&apiKey=e39c3ad28c6d41ad9bd45f164ce3fa09`);
